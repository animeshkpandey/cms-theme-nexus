...
export default function Services() {
  const { whatSection, whyFincunSection } = useData();
        ...
        >
          <Grid>
            <Grid.Col span={{ base: 12, md: 6 }}>
              <Chip size="md" variant="outline">
                {whyFincunSection.tag}
              </Chip>
              <Space my="md" />
              <Title order={1}>{whyFincunSection.title}</Title>
              <Space my="2em" />
              <Text>{whyFincunSection.subTitle}</Text>
              <Space my="2em" />
              <Flex justify={{ base: "center", md: "start" }}>
                <Button color="fincun" size="lg">
                  {whyFincunSection.cta}
                </Button>
              </Flex>
            </Grid.Col>
            <Grid.Col span={{ base: 12, md: 6 }}>
              <Grid gutter="xl">
                {whyFincunSection.features.map((f) => (
                  <Grid.Col span={{ base: 12, md: 6 }}>
